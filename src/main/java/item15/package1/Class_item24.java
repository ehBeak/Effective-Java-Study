...
public class Class_item24 {
    ...
    private static class packagePrivateClass_privateStatic {

        private String a;

    }

    // package-private 인터페이스를 사용하는 클래스 내에서 private static 으로 중첩시킴
    private static interface packagePrivateInterface_privateStatic {
